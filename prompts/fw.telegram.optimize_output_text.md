...
- Follow the Telegram markdown rules from the main Telegram session instructions. If rich messages are enabled, tables are allowed when they clearly improve readability.
